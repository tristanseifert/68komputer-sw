...
#define UMM_MALLOC_CFG_HEAP_ADDR (&__heap_start)
#define UMM_MALLOC_CFG_HEAP_SIZE (&__heap_end - &__heap_start)
...
// enable integrity checks for debug builds
#ifdef DEBUG
...
#  define UMM_HEAP_CORRUPTION_CB() printf("\bHeap Corruption!\r\n")
#else
...
// enable poison checks for debug builds
#ifdef DEBUG
